                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div style="background-color:black" class="form-group">
                            <asp:Button ID="btnSave" runat="server" BackColor="Black" BorderColor="Gray" Text="Register"  OnClick="btnSave_Click" class="btn btn-info btn-black" ValidationGroup="vgRegister"  CausesValidation="True" ViewStateMode="Inherit" />
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <a style="background-color:black; border-block-color:gray" href="Login.aspx" class="btn btn-info btn-block">Login</a>
                        </div>
                    </div>
                </div>
            </div>
