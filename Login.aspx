                        ...
                        <div id="loginform" class="form-horizontal" role="form">
                            ...
                            <div  class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    <asp:Button runat="server" ID="btnLogin" BackColor="Black" BorderColor="gray" Text="Log in" CssClass="btn btn-success" style="width:auto;"   ValidationGroup="vgLogin" CausesValidation="True" OnClick="btnLogin_Click" /><br /><br />
                                    <a style="color:black"; href="UserRegistration.aspx">Register as a new user</a>
                                </div>
                            </div>
                        </div>
                    </div>
